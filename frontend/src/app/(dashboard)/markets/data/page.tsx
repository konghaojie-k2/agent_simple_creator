        ...
        <div className="max-w-6xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">Manage your datasets</p>
            </div>
            <Link
              href="/markets/data/new"
        ...
        <div className="px-4 sm:px-0">
          ...
          {filteredDatasets.length === 0 ? (
            <div className="bg-white rounded-xl shadow-sm border border-purple-100 p-12 text-center">
              ...
              <p className="text-gray-500 mb-6">Create your first dataset to get started</p>
              <Link
                href="/markets/data/new"
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      ...
                      <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800">
                        {datasetTypeLabels[dataset.dataset_type] || dataset.dataset_type}
                      </span>
                    </div>
                  </div>
                  {dataset.description && (
                    <p className="text-sm text-gray-500 mb-3 line-clamp-2">{dataset.description}</p>
                  )}
